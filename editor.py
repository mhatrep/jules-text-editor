...
class TextEditor:
    def __init__(self, root):
        ...
        self.timezones_to_display = [
            ...
            {"label": "UK:",             "tz": "Europe/London"},      # Changed
            {"label": "India (IST):",     "tz": "Asia/Kolkata"},     # Changed
            {"label": "Japan (JST):",     "tz": "Asia/Tokyo"},       # Changed
    ...
    def open_script_runner_dialog(self, event=None):
        dialog = ScriptRunnerDialog(self) # Pass self (TextEditor instance) as master
        # dialog.grab_set() # Optional: if you want it to be modal
        return "break"

    def open_doc_converter_dialog(self, event=None):
        dialog = DocumentConverterDialog(self) # Pass self as master
        # dialog.grab_set() # Optional: if you want it to be modal
        return "break"
