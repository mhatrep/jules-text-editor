...
class SecurityToolDialog(tk.Toplevel):
    ...
    def _setup_certificate_tools_tab(self):
        ...
        self.cert_tree.column("subject", width=200, anchor=tk.W, stretch=tk.YES)
        self.cert_tree.column("issuer", width=200, anchor=tk.W, stretch=tk.YES)
        self.cert_tree.column("serial", width=180, anchor=tk.W, stretch=tk.NO)
        self.cert_tree.column("valid_to", width=130, anchor=tk.W, stretch=tk.NO)
        self.cert_tree.column("source", width=250, anchor=tk.W, stretch=tk.YES)
    ...
    def _setup_other_utilities_tab(self):
        ...
        self.hash_input_text.grid(row=1, column=0, columnspan=3, padx=5, pady=5, sticky="ew")
        ...
        self.url_text_area.grid(row=1, column=0, columnspan=2, padx=5, pady=5, sticky="ew")
